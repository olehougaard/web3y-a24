...
type ConcedeRequest = {conceded: boolean, player: Player}
...
export const concede = (gameNumber: number, player: Player) => create<ConcedeRequest, Game>(`http://localhost:8080/games/${gameNumber}/moves`, { conceded: true, player})
