import { configureStore, createSlice, PayloadAction, Action, combineReducers } from '@reduxjs/toolkit'
...
export const reducer = combineReducers({game: gameSlice.reducer, lobby: lobbySlice.reducer })
export const init_state: State = { game: gameSlice.getInitialState(), lobby: lobbySlice.getInitialState()}
