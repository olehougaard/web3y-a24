...
const patchGame = async (gameNumber: number, body: Partial<Game>): Promise<Game> => callApi<Game>(`http://localhost:8080/games/${gameNumber}`, {method: 'PATCH', body: JSON.stringify(body)})
